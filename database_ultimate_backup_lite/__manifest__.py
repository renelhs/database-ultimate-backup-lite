# -*- coding: utf-8 -*-
{
    ...
    'summary': "Free automated local database backups with retention policies, integrity verification, and monitoring",

    'description': """
        Database Ultimate Backup Lite - Free Local Backup Solution
        ==========================================================

        A free, reliable database backup solution for Odoo 19.0 with local storage,
        automated scheduling, retention policies, and comprehensive monitoring.

        Zero external dependencies - just install and start backing up!
        ...
        * Granular model-level permissions
        ...
        SFTP, parallel uploads, and more!
    """,
