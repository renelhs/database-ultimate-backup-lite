...
- These additions are purely informational. Every existing Lite feature — local
  storage, SFTP, scheduling, retention and email notifications — keeps working
  exactly as before, with no popups, reminders or workflow interruptions.
