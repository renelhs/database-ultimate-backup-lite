# Database Ultimate Backup Lite for Odoo 16.0
...
A free, reliable database backup solution for Odoo 16.0 with **local and SFTP remote storage**, automated scheduling, retention policies, and comprehensive monitoring.
...
### Built With
- Odoo 16.0 Community/Enterprise Framework
- AsyncSSH for high-performance SFTP transfers
- Strategy design pattern for extensibility

---

**Database Ultimate Backup Lite** - Free local & SFTP backup solution for Odoo 16.0
